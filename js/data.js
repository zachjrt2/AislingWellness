...
const CATEGORIES = [
  {
    ...
    label: "Massage & Body",
    subCategories: [
      { label: "Therapeutic Massage", serviceIds: ["swedish", "deep-tissue", "couples"] }
    ]
  },

  {
    ...
    subCategories: [
      ...
      },
      {
        ...
        serviceIds: [
          "microneedling", "nanoneedling", "nanoneedling-exosomes",
...

  {
    ...
    label: "Lashes & Brows",
    subCategories: [
      { label: "Lash & Brow Artistry", serviceIds: ["lash-lift", "brow-lamination", "lash-dye", "brow-dye", "lash-lift-tint-combo", "brow-lamination-tint"] },
      { label: "Lash Extensions", serviceIds: ["classic-full-set", "hybrid-full-set", "volume-full-set", "hybrid-refill", "classic-refill", "volume-extended-fill", "volume-fill", "mega-volume-full-set", "mega-volume-extended-fill", "mega-volume-fill", "mega-mini-fill", "mini-fill", "touch-up-classic", "touch-up-hybrid", "lash-removal", "add-on-wispy-wet"] }
    ]
  },
...
const SERVICES = [
...

  {
    ...
    providerIds: ["regan", "kasden", "marci", "jaime", "vivian"]
  },
  ...
  // ── LASHES & BROWS ──
  {
    ...
    duration: "45 min", price: "From $55", area: "Eyelashes",
    providerIds: ["kasden", "jazmyn"]
  },

  {
    ...
    duration: "45 min", price: "From $60", area: "Eyebrows",
    providerIds: ["kasden", "marci", "jazmyn"]
  },

  {
    ...
    duration: "30 min", price: "From $25", area: "Eyelashes",
    providerIds: ["marci", "jazmyn"]
  },

  {
    ...
    duration: "30 min", price: "From $15", area: "Eyebrows",
    providerIds: ["marci", "jazmyn"]
  },

  {
    id: "classic-full-set", name: "Classic Full Set", category: "lashes", icon: "glow",
    description: "Natural, elegant lash extensions for everyday definition.",
    fullDescription: "Our Classic Full Set applies a single extension to each natural lash, creating a clean, mascara-like effect. Perfect for those seeking a subtle enhancement to their natural beauty.",
    tags: ["Classic", "Lash extensions", "Natural", "Everyday"],
    duration: "2 hours", price: "From $90", area: "Eyelashes",
    providerIds: ["jazmyn"]
  },

  {
    id: "hybrid-full-set", name: "Hybrid Full Set", category: "lashes", icon: "glow",
    description: "A perfect blend of classic and volume for texture and fullness.",
    fullDescription: "Hybrid lashes combine individual classic lashes with volume fans to create a textured, wispy look. This set offers more fullness than classic while maintaining a soft, natural appearance.",
    tags: ["Hybrid", "Lash extensions", "Textured", "Fullness"],
    duration: "2.25 hours", price: "From $100", area: "Eyelashes",
    providerIds: ["jazmyn"]
  },

  {
    id: "hybrid-refill", name: "Hybrid Refill", category: "lashes", icon: "glow",
    description: "Standard maintenance for hybrid lashes (2-3 weeks).",
    fullDescription: "Meticulous refill to maintain your textured, wispy hybrid look. We replace shed extensions and ensure a seamless blend.",
    tags: ["Maintenance", "Hybrid", "Regular care"],
    duration: "1.25 hours", price: "From $75", area: "Eyelashes",
    providerIds: ["jazmyn"]
  },

  {
    id: "classic-refill", name: "Classic Refill", category: "lashes", icon: "glow",
    description: "Standard maintenance for classic lashes (2-3 weeks).",
    fullDescription: "Keep your natural-look classic set at its best. We replace extensions that have naturally shed along with your lash cycle.",
    tags: ["Maintenance", "Classic", "Regular care"],
    duration: "1 hour", price: "From $75", area: "Eyelashes",
    providerIds: ["jazmyn"]
  },

  {
    id: "touch-up-classic", name: "Classic Touch-Up", category: "lashes", icon: "glow",
    description: "Quick 30-minute refresh for classic lashes.",
    fullDescription: "A fast touch-up for any unexpected gaps in your classic set. Ideal between regular fills.",
    tags: ["Quick", "Touch-up", "Classic"],
    duration: "30 min", price: "From $35", area: "Eyelashes",
    providerIds: ["jazmyn"]
  },

  {
    id: "touch-up-hybrid", name: "Hybrid Touch-Up", category: "lashes", icon: "glow",
    description: "Quick 45-minute refresh for hybrid lashes.",
    fullDescription: "Address gaps and maintain the texture of your hybrid set between regular maintenance appointments.",
    tags: ["Quick", "Touch-up", "Hybrid"],
    duration: "45 min", price: "From $45", area: "Eyelashes",
    providerIds: ["jazmyn"]
  },

  {
    id: "lash-lift-tint-combo", name: "Lash Lift & Tint Combo", category: "lashes", icon: "glow",
    description: "Curled and darkened natural lashes for maximum impact.",
    fullDescription: "Combine our professional lash lift with a deep tint for the ultimate low-maintenance beauty ritual. No mascara or curlers needed.",
    tags: ["Combo", "Low-maintenance", "Maximum impact"],
    duration: "1 hour", price: "From $65", area: "Eyelashes",
    providerIds: ["jazmyn"]
  },

  {
    id: "brow-lamination-tint", name: "Brow Lamination With Tint", category: "lashes", icon: "face",
    description: "Symmetry, fullness, and color for perfectly groomed brows.",
    fullDescription: "The ultimate brow overhaul. We restructure your brow hairs for a fuller, lifted shape and apply a custom tint for added depth and definition.",
    tags: ["Brows", "Combo", "Fullness", "Definition"],
    duration: "1 hour", price: "From $80", area: "Eyebrows",
    providerIds: ["jazmyn"]
  },

  {
    id: "add-on-wispy-wet", name: "Add-on: Wispy or Wet Look", category: "lashes", icon: "star",
    description: "Enhance any full set with a trending wispy or wet texture.",
    fullDescription: "A specialized styling add-on that can be applied to any full set or fill to achieve a customized textured finish.",
    tags: ["Add-on", "Styling", "Trends"],
    duration: "15 min", price: "From $10", area: "Eyelashes",
    providerIds: ["jazmyn"]
  },

  {
    ...
    duration: "2.5 hours", price: "From $120", area: "Eyelashes",
    providerIds: ["taylor", "jazmyn"]
  },

  {
    ...
    duration: "1.75 hours", price: "From $95", area: "Eyelashes",
    providerIds: ["taylor", "jazmyn"]
  },

  {
    ...
    duration: "1.5 hours", price: "From $80", area: "Eyelashes",
    providerIds: ["taylor", "jazmyn"]
  },

  {
    ...
    duration: "3 hours", price: "From $200", area: "Eyelashes",
    providerIds: ["taylor", "jazmyn"]
  },

  {
    ...
    duration: "2 hours", price: "From $105", area: "Eyelashes",
    providerIds: ["taylor", "jazmyn"]
  },

  {
    ...
    duration: "1.75 hours", price: "From $90", area: "Eyelashes",
    providerIds: ["taylor", "jazmyn"]
  },

  {
    ...
    duration: "45 mins", price: "From $50", area: "Eyelashes",
    providerIds: ["taylor", "jazmyn"]
  },

  {
    ...
    duration: "30 mins", price: "From $40", area: "Eyelashes",
    providerIds: ["taylor", "jazmyn"]
  },

  {
    ...
    duration: "30 mins", price: "From $25", area: "Eyelashes",
    providerIds: ["taylor", "jazmyn"]
  },
...
const PROVIDERS = [
  {
    ...
    photo: "images/staff/Teressa-Sisk-Director-of-Operations-Teeth-Whitening-Foot-Detox-1024x1536.jpg",
...

  {
    ...
    photo: "images/staff/ReganAntony.jpg",
    avatarInitials: "RB",
...

  {
    ...
    credentials: "LE",
    years: 5,
    photo: "images/staff/Kasden-Davis.jpeg",
    avatarInitials: "KD",
  ...
  },
  {
    ...
    credentials: "LE",
    years: 15,
    photo: "images/staff/Marci-Puryear-Aesthetician-scaled.jpg",
    avatarInitials: "MP",
...

  {
    ...
    credentials: "LE",
    years: 22,
    photo: "images/staff/Jaime-Reville-1229x1536.jpg",
    avatarInitials: "JR",
...

  {
    ...
    credentials: "LMT",
    years: 7,
    photo: "images/staff/Hannah-Lowerey.jpg",
    avatarInitials: "HL",
...

  {
    ...
    credentials: "LE",
    years: 6,
    photo: "images/staff/Lauren-Gomez.jpg",
    avatarInitials: "LG",
...

  {
    ...
    credentials: "LMT",
    photo: "images/ErinStone.jpg",
    avatarInitials: "ES",
    avatarBg: "rgba(128, 0, 128, 0.2)",
    avatarColor: "#800080",
    bio: "Erin is a Licensed Massage Therapist (LMT) known for her intuitive touch and dedicated focus on client wellness. Whether she’s providing a gentle Swedish massage or a more targeted deep tissue session, Erin specializes in creating a tranquil environment where clients can truly unwind and heal. With her distinctive purple hair and calming presence, she is a wonderful addition to the Aisling therapeutic team.",
    specialties: ["Swedish massage", "Deep tissue", "Couples massage", "Prenatal massage"],
    bookingUrl: "https://aislingwellnesscenter.com/book",
    staffEmail: "ertx33@aol.com",
    serviceIds: ["swedish", "deep-tissue", "couples"]
  },

  {
    ...
    name: "Jazmyn Legaria",
    title: "Lash Artist",
    credentials: "Lash Specialist",
    years: 1, // Assumed since unknown
    photo: "images/JazmynRios.jpg",
    avatarInitials: "JL",
    avatarBg: "rgba(122, 158, 104, 0.2)",
    avatarColor: "#7a9e68",
    bio: "Jazmyn is a dedicated Lash Artist with a passion for precision and eye-enhancing artistry. Specializing in everything from natural-look classic sets to textured volume extensions, she prides herself on creating custom designs that perfectly frame each client’s face. Jazmyn’s gentle touch and meticulous technique ensure a relaxing experience and results that last.",
    specialties: ["Classic & Hybrid Sets", "Volume Artistry", "Lash Lifts", "Brow Lamination"],
    bookingUrl: "https://jazmynlegaria.glossgenius.com/services",
    serviceIds: [
      "volume-full-set",
      "classic-full-set",
      "hybrid-full-set",
...
const CREDENTIALS = [
  ...
  "5-star rated in Lubbock", "95+ years of combined experience", "West Texas's premier med spa",
];
